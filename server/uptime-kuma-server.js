...
class UptimeKumaServer {
     ...
     * @param {number[]|null} monitorIDList - Optional list of monitor IDs to restrict the result to.
     * @returns {Promise<object>} A promise that resolves to an object with monitor IDs as keys and monitor objects as values.
     *
     * Generated by Trelent
     */
    async getMonitorJSONList(userID, monitorID = null, monitorIDList = null) {
        let query = " user_id = ? ";
        ...
        if (monitorIDList != null) {
            ...
            query += `AND id IN (${monitorIDList.map(() => "?").join(",")}) `;
            queryParams.push(...monitorIDList);
        }
